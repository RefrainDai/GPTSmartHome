...
- JavaFX 3D 智能家居可视化界面：客厅、卧室、玄关、设备卡片、状态动画。
...
主视图使用 JavaFX 3D `SubScene` 渲染虚拟户型，不需要更换语言。客厅、卧室和玄关以 3D 房间结构展示，所有虚拟设备都有对应 3D 模型：客厅灯、卧室灯、空调、窗帘、电视、风扇、加湿器、门锁和扫地机器人。

设备状态会实时映射到 3D 场景：灯光会发光，窗帘会开合，电视屏幕会亮起，风扇会旋转，加湿器会显示雾气，门锁会切换颜色，扫地机器人会移动到工作位置。
